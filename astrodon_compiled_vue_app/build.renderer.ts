// it is possible to create vue spa with vue tools (vue cli or vue vite ..)
// use hash router
// build your app
// copy past in renderer
...
const assets = [
  ...
  join(__dirname, './renderer/src/vue3.js'),
  join(__dirname, './renderer/src/vueRouter.js'),
];
